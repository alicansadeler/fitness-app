      ...
      <div className="mx-auto w-5/6">
        <div className="md:w-3/5 mb-6">
          ...
          <p>
            ...
            necessitatibus blanditiis quibusdam debitis fuga voluptatibus
            officia quo culpa molestias explicabo aliquam veritatis corporis,
            libero facilis iste ipsa quisquam facere quaerat!
          </p>
        </div>
