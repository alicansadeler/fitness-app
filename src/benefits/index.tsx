      ...
      >
        <div className="md:w-3/5">
          ...
          <p>
            ...
            autem veniam maxime sint nihil voluptate fuga doloribus distinctio
            voluptatibus, excepturi, asperiores temporibus officiis iste quos
            deleniti magni quia error.
          </p>
        </div>
      </motion.div>
        ...
        <div>
          <div className="relative mt-24">
            <div className="before:content-abstractwaves before:absolute before:-top-14 before:left-20">
              ...
              >
                <Htext>Million of member very happy getting</Htext>

                <span className="text-gray-50 font-bold flex">
                  <a className="flex mr-2 bg-primary-500 px-3 py-2 rounded-xl">
                    Fit
                  </a>
                  <a className="flex mr-2 bg-primary-500 px-3 py-2 rounded-xl">
                    Gym
              ...
              <motion.div
                className="mt-8 md:flex items-center gap-8"
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true, amount: 0.5 }}
                transition={{ duration: 0.5 }}
              ...
              >
                <p className="my-5">
                  ...
                  corrupti laudantium natus modi at eius soluta tempore? Earum
                  sunt nesciunt quod, cum magni aperiam, debitis non suscipit
                  maiores officia aliquam.
                </p>
                <p className="my-5">
